...
static const XA_TrackDef xa_tracks[] = {
	//MENU.XA
	{XA_Menu, XA_LENGTH(5500)}, //XA_GettinFreaky
	{XA_Menu, XA_LENGTH(3840)},  //XA_GameOver
	//WEEK1A.XA
	{XA_Week1A, XA_LENGTH(14900)}, //XA_Bopeebo
	{XA_Week1A, XA_LENGTH(17400)}, //XA_Fresh
	//WEEK1B.XA
	{XA_Week1B, XA_LENGTH(15000)}, //XA_Dadbattle
	{XA_Week1B, XA_LENGTH(6800)}, //XA_Tutorial
	//WEEK2A.XA
	{XA_Week2A, XA_LENGTH(17100)}, //XA_Spookeez
