...
static const char *funny_messages[][2] = {
	...
	{"FUNKIN", "FOREVER"},
	{"WHAT THE HELL", "LOST SILVER PSX"},
	{"LIKE LAMMY", "BUT COOLER"},
	{"NO JUMPSCARES", "SORRY"},
	{"NO PENDULM MECHANIC", "SORRY"},
	{"MO NOTE GLITCH", "SORRY"},
	{"DCNICK", "SETTING STANDARDS"},
	{"POKEMON X AND Y", "DOG WATER"},
	{"PSXDEV", "HOMEBREW"},
	{"JOHN PAUL", "BEST SUPPORTER"},
	{"DOPE ASS GAME", "PLAYSTATION MAGAZINE"},
	{"BANBUDS", "FOREVER"},
	{"NO COOL MECHANICS", "CRY ABOUT IT"},
	{"OK OKAY", "WATCH THIS"},
	{"ITS MORE SCARY", "THAN ANYTHING"},
			...
			else
			{
				...
				//Fallthrough
					...
					case 1:
						...
						menu.font_bold.draw(&menu.font_bold, "BANBUDS", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 16, FontAlign_Center);
						break;
				...
				//Fallthrough
					case 14:
						menu.font_bold.draw(&menu.font_bold, "LULLABY", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 8, FontAlign_Center);
				//Fallthrough
					case 13:
	...
	//Fallthrough
		...
		case MenuPage_Story:
		{
			static const struct
			{
				...
				{"1", StageId_1_1, "HYPNOS LULLABY", {"SAFETY LULLABY", "LEFT UNCHECKED", "MONOCHROME"}},
			};
		...
		case MenuPage_Freeplay:
		{
			static const struct
			{
				...
				{StageId_1_1, "SAFTEY LULLABY"},
				{StageId_1_2, "LEFT UNCHECKED"},
				{StageId_1_3, "MONOCHROME"},
				{StageId_2_1, "MISSINGNO"}
			};
		...
		case MenuPage_Mods:
		{
			static const struct
			{
				...
				{StageId_Kapi_2, "   FNF LULLABY PORT", false},				
				...
				{StageId_Clwn_1, "BANBUDS", false},
				{StageId_Kapi_2, "   DIRECTOR", false},	
				{StageId_Clwn_1, "ASH", false},
				{StageId_Clwn_1, "   PROGRAMMER", false},
				{StageId_Clwn_1, "YOSHHUBS", false},
				{StageId_Clwn_1, "   PROGRAMMER", false},
				{StageId_Clwn_1, "ADAM MCHUMMUS", false},
				{StageId_Clwn_1, "   COMPOSER", false},
				{StageId_Clwn_1, "THEINNUENDO", false},
				{StageId_Clwn_1, "   COMPOSER", false},
				{StageId_Clwn_1, "NIMBUS CUMULUS", false},
				{StageId_Clwn_1, "   COMPOSER", false},
				{StageId_Clwn_1, "UNCLE JOEL", false},
				{StageId_Clwn_1, "   ANIMATOR", false},
				{StageId_Clwn_1, "CHILLRAPTOR", false},
				{StageId_Clwn_1, "   BG ARTIST", false},
				{StageId_Clwn_1, "SCORCHVX", false},
				{StageId_Clwn_1, "   ARTIST", false},
				{StageId_Clwn_1, "SANDPLANNET", false},
				{StageId_Clwn_1, "   CHARTER", false},
				{StageId_Clwn_1, "FIDY", false},
				{StageId_Clwn_1, "   CHARTER", false},
				{StageId_Clwn_1, "TYPIC", false},
				{StageId_Clwn_1, "   ANIMATOR", false},
				{StageId_Clwn_1, "MR NOL", false},
				{StageId_Clwn_1, "   VOCAL EDITS", false},
				{StageId_Clwn_1, "BONESTHESKELEBUNNY", false},
				{StageId_Clwn_1, "   ARTIST", false},
				{StageId_Clwn_1, "FUEGZERO", false},
				{StageId_Clwn_1, "   OG MAC PORT", false},
